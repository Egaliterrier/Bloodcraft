...
public static class ConfigService
{
    ...
    public static class ConfigInitialization
    {
        ...
        [
			...
			new ConfigEntryDefinition("Professions", "WoodcuttingFactor" , 1f, "Multiplier for experience gained in the woodcutting profession."),
            new ConfigEntryDefinition("Professions", "MiningFactor" , 1f, "Multiplier for experience gained in the mining profession."),
            new ConfigEntryDefinition("Professions", "BlacksmithingFactor" , 3f, "Multiplier for experience gained in the blacksmithing profession."),
            new ConfigEntryDefinition("Professions", "TailoringFactor" , 3f, "Multiplier for experience gained in the tailoring profession."),
            new ConfigEntryDefinition("Professions", "FishingFactor" , 3f, "Multiplier for experience gained in the fishing profession."),
            new ConfigEntryDefinition("Professions", "AlchemyFactor" , 2f, "Multiplier for experience gained in the alchemy profession."),
            new ConfigEntryDefinition("Professions", "HarvestingFactor" , 0.20f, "Multiplier for experience gained in the harvesting profession."),
            new ConfigEntryDefinition("Professions", "EnchantingFactor" , 4f, "Multiplier for experience gained in the enchanting profession."),
